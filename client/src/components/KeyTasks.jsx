    ...
    <div className="glass-card p-5">
      <div className="flex items-center justify-between section-header">
        ...
        <div className="flex items-center gap-2">
          ...
          <button onClick={onNew} className="inline-flex items-center justify-center rounded-lg text-xs w-[26px] h-[26px] transition hover:brightness-105 active:scale-[0.97] flex-shrink-0" style={{ background: 'rgba(120,120,128,0.08)', border: '1px solid rgba(120,120,128,0.22)', color: '#8E8E93' }} title="添加">
