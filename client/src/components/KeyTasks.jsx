    ...
    <div className="glass-card p-5">
      <div className="flex items-center justify-between section-header">
        ...
        <div className="flex items-center gap-2">
          ...
          <button onClick={onNew} className="inline-flex items-center justify-center rounded-[8px] text-[#1c1c1e] text-xs w-[26px] h-[26px] transition hover:brightness-105 active:scale-[0.97] flex-shrink-0" style={{ background: 'rgba(120,120,128,0.12)' }} title="添加">
