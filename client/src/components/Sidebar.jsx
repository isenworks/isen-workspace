...
const ICONS = {
  ...
  inbox:   (<svg fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24"><path d="M6 8a2 2 0 0 1 2-2h1.5a2.5 2.5 0 1 1 5 0H16a2 2 0 0 1 2 2v1.5a2.5 2.5 0 1 1 0 5V16a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2V8z"/></svg>),
  knowledge: (<svg fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24"><rect x="3" y="3" width="18" height="18" rx="2.5"/><path d="M12 3v10a2 2 0 1 1 0 4v4"/><path d="M3 12h4a2 2 0 1 1 4 0h10"/></svg>),
