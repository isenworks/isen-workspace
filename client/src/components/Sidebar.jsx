...
const ICONS = {
  ...
  knowledge: (<svg fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24"><rect x="3" y="3" width="18" height="18" rx="2.5"/><path d="M12 3 L12 9 A3 3 0 0 0 12 15 L12 21"/><path d="M3 12 L9 12 A3 3 0 0 0 15 12 L21 12"/></svg>),
