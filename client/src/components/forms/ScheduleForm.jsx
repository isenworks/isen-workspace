...
// category: 1=重要紧急, 2=重要不紧急, 6=深度复盘(蓝), 3=常规事项, 5=生活体验
...
const CATEGORIES = [
  ...
  { v: 6, label: '深度复盘',   dot: '#007aff', bg: '#e0ecff', border: '#a3c9ff', text: '#007aff', textActive: '#1c1c1e' },
