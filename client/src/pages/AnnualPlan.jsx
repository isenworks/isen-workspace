...
/* ---------- 9. 视图 · 能力 ---------- */
function AbilityView({ abilities, onMsAdd, onMsEdit, onMsToggleDone, onAbilityAdd, onAbilityEdit, onAbilityRemove, onAbilityMarkDone, onAbilityRestore, scoreHistory, onStartAssessment }) {
  const dynAb = abilities || ABILITY;
  const year = new Date().getFullYear();
