            ...
            <div className="flex flex-col gap-2 min-h-0 flex-1">
              ...
              <div className="overflow-y-auto overflow-x-hidden nice-scroll pr-0.5 flex flex-col justify-start gap-1 mt-1 flex-1 min-h-0">
                ...
                {todayFestivals.map(f => (
                  <div key={f} className="flex items-center gap-2 px-2 py-1.5 rounded-[12px] transition-colors hover:bg-[rgba(120,120,128,0.06)]">
              ...
              {followUpList.map(u => {
                ...
                return (
                  <button
                    ...
                    className="flex items-center gap-2.5 text-left rounded-[12px] px-2 py-1.5 transition hover:bg-[rgba(120,120,128,0.06)] flex-shrink-0 w-full"
                  >
